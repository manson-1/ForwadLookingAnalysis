...
analysis = myFLA('EURUSD', 2000, 500, 125, 1); % initialize object with basic input informations
...
% out of sample testing     -> 125 days     = ~0.5 years for out of sample testing data with optimized supertrend parameters
% ------------------------